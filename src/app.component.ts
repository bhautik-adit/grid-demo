...
import { FilterService, SortService, GridComponent, IFilter, VirtualScrollService, GridModule, FreezeService } from '@syncfusion/ej2-angular-grids';
...
@Component({
    ...
    providers: [FilterService, SortService, VirtualScrollService,FreezeService],
    standalone: true,
